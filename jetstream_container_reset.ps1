...
$results = Invoke-RestMethod -URI "${BaseURL}/jetstream/container/${JS_CONTAINER_REF}/reset" -WebSession $session -Method Post -Body $json -ContentType 'application/json'
$status = ParseStatus $results "${ignore}"
